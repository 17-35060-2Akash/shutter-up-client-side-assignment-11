        ...
        <div className="bg-base-200 py-32">
            <div className="text-center flex flex-col">
                ...
                <div className='flex justify-center align-middle my-16 mt-20 mx-6 relative'>
                    <input onChange={handleSearchOnChange} type="text" name='search-bar' placeholder='Search events' className="input input-bordered w-8/12 text-2xl px-10 pl-14 h-16" title='Search will only work on full words' />
