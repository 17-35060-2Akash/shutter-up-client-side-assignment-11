        ...
        <div className='h-[800px] lg:h-[900px] flex flex-col justify-center items-center'>
            <p className='text-2xl md:px-4 md:text-3xl mb-24 font-lighter uppercase pb-3' >
                <span className='bg-white px-2 py-2 pb-3'>
                    <span className='bg-cyan-500 text-white px-4 pb-1'>Send</span>
            ...
            <div className='w-96 p-9 pt-14 shadow-xl rounded-xl glass'>
                ...
                <form action='https://formspree.io/f/xzbqpvkb' method='POST' >
                    ...
                    <div className="form-control w-full max-w-xs mb-6 border border-b-0 border-spacing-4 rounded-lg">
                        {/* <label className="label font-medium"><span className="label-text">Name</span></label> */}
                        <textarea
                    ...
                    <input type="submit" value="Send" className='btn btn-neutral text-lg w-full bg-cyan-500 text-white border-0 ' />
